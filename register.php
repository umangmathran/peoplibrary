...
$room = $mysqli->escape_string($_POST['roomno']);
$mobno = $mysqli->escape_string($_POST['mobno']);
...
if ( $result->num_rows > 0 ) {
    ...
    $sql = "INSERT INTO user VALUES ('$fname', '$lname', '$email', '$password', '$hostel', '$room', '$mobno', '$hash', 0)";
    ...
    if ( $mysqli->query($sql) ){
        ...
        $to      = $email;
        $subject = 'Account Verification ( People\'s Library )';
        $message_body = '
        Hello '.$first_name.',
